...
public class ThisServicePart2_Provider2_PactGen 
{
	public static final String CONSUMER = "Checkout" + "Part2";
...
//    Provider1Api client;
	...
	public void runTest() {
        ...
        String resp = restTemplate.getForObject(url + path + "?id={id}", String.class, 2);
    }
